...
int main(void)
{
	...
	if((shm_anfordid=shmget(SHM_READKEY,sizeof(anforder_shm),IPC_CREAT|S_IRWXG|S_IRWXO|S_IRWXU|IPC_EXCL))==-1){
	...
	if((shm_antwortid=shmget(SHM_WRITEKEY,sizeof(antwort_shm),IPC_CREAT|S_IRWXG|S_IRWXO|S_IRWXU|IPC_EXCL))==-1){
	...
	if((shm_antwort= shmat(shm_antwortid,NULL,0))==(void*)-1){
        ...
        if((sem_anfordid=semget(SEM_READKEY,1,IPC_CREAT|IPC_EXCL|S_IRWXG|S_IRWXO|S_IRWXU))==-1){
        ...
        if((sem_antwortid=semget(SEM_WRITEKEY,1,IPC_CREAT|IPC_EXCL|S_IRWXG|S_IRWXO|S_IRWXU))==-1){
